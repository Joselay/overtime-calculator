...
export const description = "An interactive area chart showing overtime hours and pay"

interface OvertimeChartData {
  date: string
  hours: number
  pay: number
}
      ...
      <CardHeader>
        ...
        <CardDescription>
          <span className="hidden @[540px]/card:block">
            Overtime hours and pay for the last 3 months
          </span>
